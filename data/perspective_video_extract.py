...
mvf = multi_video_file('./2024072418/20240724183913.mvf')
frame_count = 0
perspective_num = 4
height = 820
width = 1400
...
for i in range(0, perspective_num):
    video_name = f'video_{i}.mp4'
    video_arr.append(cv2.VideoWriter(video_name, cv2.VideoWriter_fourcc(*'mp4v'), 30, (width, height)))
    print('create' + video_name)
